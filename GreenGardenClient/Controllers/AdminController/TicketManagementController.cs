...
namespace GreenGardenClient.Controllers.AdminController
{
    public class TicketManagementController : Controller
    {
        ...
        {
            var ticket = await GetDataFromApiAsync<List<TicketVM>>("https://be_green.chunchun.io.vn/api/Ticket/GetAllTickets");
        ...
        public async Task<IActionResult> UpdateTicketDetail(int ticketId)
        {
            ...
            try
            {
                ...
                var campingCategories = await GetDataFromApiAsync<List<TicketCategoryVM>>("https://be_green.chunchun.io.vn/api/Ticket/GetAllTicketCategories");
        ...
        public async Task<IActionResult> UpdateTicket(UpdateTicketVM model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "https://be_green.chunchun.io.vn/api/Ticket/UpdateTicket";
            try
            {
        ...
        {
            string apiUrl = $"https://be_green.chunchun.io.vn/api/Ticket/ChangeTicketStatus?ticketId={ticketId}";
        ...
        public async Task<IActionResult> CreateTicket(AddTicketVM model, IFormFile PictureUrl)
        {
            ...
            string apiUrl = "https://be_green.chunchun.io.vn/api/Ticket/AddTicket";
