...
namespace GreenGardenClient.Controllers.AdminController
{
    ...
    public class GearManagementController : Controller
    {
        ...
        {
            var gear = await GetDataFromApiAsync<List<GearVM>>("http://103.20.97.182:5124/api/CampingGear/GetAllCampingGears");
        ...
        public async Task<IActionResult> GearDetail(int gearId)
        {
            ...
            try
            {
                ...
                var campingCategories = await GetDataFromApiAsync<List<GearCategoryVM>>("http://103.20.97.182:5124/api/CampingGear/GetAllCampingGearCategories");
        ...
        public async Task<IActionResult> UpdateGear(UpdateGearVM model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "http://103.20.97.182:5124/api/CampingGear/UpdateCampingGear";
            try
            {
        ...
        {
            string apiUrl = $"http://103.20.97.182:5124/api/CampingGear/ChangeGearStatus?gearId={gearId}";
        ...
        public async Task<IActionResult> CreateGear(AddGearVM model, IFormFile PictureUrl)
        {
            ...
            string apiUrl = "http://103.20.97.182:5124/api/CampingGear/AddCampingGear";
