...
namespace GreenGardenClient.Controllers.AdminController
{
    ...
    public class GearManagementController : Controller
    {
        ...
        {
            var gear = await GetDataFromApiAsync<List<GearVM>>("https://db.chunchun.io.vn/api/CampingGear/GetAllCampingGears");
        ...
        public async Task<IActionResult> GearDetail(int gearId)
        {
            ...
            var apiUrl = $"https://db.chunchun.io.vn/api/CampingGear/GetCampingGearDetail?id={gearId}";
            ...
            try
            {
                ...
                var campingCategories = await GetDataFromApiAsync<List<GearCategoryVM>>("https://db.chunchun.io.vn/api/CampingGear/GetAllCampingGearCategories");
        ...
        public async Task<IActionResult> UpdateGear(UpdateGearVM model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "https://db.chunchun.io.vn/api/CampingGear/UpdateCampingGear";
            try
            {
        ...
        {
            string apiUrl = $"https://db.chunchun.io.vn/api/CampingGear/ChangeGearStatus?gearId={gearId}";
        ...
        public async Task<IActionResult> CreateGear(AddGearVM model, IFormFile PictureUrl)
        {
            ...
            string apiUrl = "https://db.chunchun.io.vn/api/CampingGear/AddCampingGear";
