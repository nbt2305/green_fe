...
namespace GreenGardenClient.Controllers.AdminController
{
    public class EmployeeManagementController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var userdata = GetDataFromApi<List<Account>>("https://db.chunchun.io.vn/api/User/GetAllEmployees");
        ...
        public async Task<IActionResult> CreateEmployee(Employee model)
        {
            ...
            string apiUrl = "https://db.chunchun.io.vn/api/User/AddEmployee";
        ...
        public async Task<IActionResult> DeleteEmployee(int id)
        {
            ...
            string apiUrl = $"https://db.chunchun.io.vn/api/User/DeleteUser/{id}";
