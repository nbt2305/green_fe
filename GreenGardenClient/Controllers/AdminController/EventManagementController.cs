...
namespace GreenGardenClient.Controllers.AdminController
{
    public class EventManagementController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var events = GetDataFromApi<List<EventVM>>("https://be_green.chunchun.io.vn/api/Event/GetAllEvents");
        ...
        public async Task<IActionResult> CreateEvent(EventVM model)
        {
            ...
            string apiUrl = "https://be_green.chunchun.io.vn/api/Event/AddEvent";
        ...
        public async Task<IActionResult> UpdateEvent(int id)
        {
            ...
            var eventItem = GetDataFromApi<UpdateEvent>($"https://be_green.chunchun.io.vn/api/Event/GetEventById?eventId={id}");
            var userRole = HttpContext.Session.GetInt32("RoleId");
        ...
        public async Task<IActionResult> UpdateEvent(UpdateEvent model, IFormFile PictureUrl, string CurrentPictureUrl)
        {
            ...
            string apiUrl = "https://be_green.chunchun.io.vn/api/Event/UpdateEvent";
            try
            {
        ...
        public async Task<IActionResult> DeleteEvent(int id)
        {
            ...
            string apiUrl = $"https://be_green.chunchun.io.vn/api/Event/DeleteEvent/{id}";
